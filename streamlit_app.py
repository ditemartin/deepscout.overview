...
st.markdown("<h5 style='text-align: center; color: grey;'>Our pricing is based on actual use of DeepScout. Select your desired frequency of monitoring and start today!</h3>", unsafe_allow_html=True)
